...
// import enforcerMulter from 'openapi-enforcer-multer'
...
export function AppFactory (options?: AppOptions): AppObject {
  ...
  app.use(enforcerMiddleware.init()) // ({ handleNotFound: false }))

  // Authorization: Bearer asdlfjadslfkjaldf.adsfjawlefjlawj.asdfadfasdf
  ...
  const routeOptions = { dependencies: [ dbController, options, upload.any() ]}
